# Run function findPhysLink with GEMMA v0.96 only for association analysis
...
# Simply leave the parameter phys.dists NULL to disable the assessment of physical distances
...
assoc <- findPhysLink(snps = "input/cgSNPs.csv",
                      ...
                      output.dir = "output", prefix = "demoLMM", gemma.path = "~/Tools/gemma",
...
saveRDS(assoc, file = "output/lmm.rds")
