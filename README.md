...
- Elements generated by the subordinate function _lmm_ (which can be used independently)  
  ...
  - snps: output of the function _importCoreGenomeSNPs_. Since the data within this list is usually of a tremendous size, users may need to move this element to another variable in order to make it faster to load the rest of elements into R.
